...
const ReceiptCard = ({ data }) => (
    <Card>
        <Card.Content>
            <Card.Header as='h1'>{data.membership.fullname}</Card.Header>
            <Card.Meta>
                <span className='date'>
                    Joined in {data.membership.memberSince}
                </span>
            </Card.Meta>
            <Card.Description>
                NEW MEMBERSHIP FEE: ${data.membership.fee}
            </Card.Description>
            <Card.Description>
                GALLON : {data.membership.remain}
            </Card.Description>
        </Card.Content>
        <Card.Content extra>
            <Icon name='user' />[{data.membership.account}] : Phone #: [
            {data.membership.areaCode + '-' + data.membership.phone}]
        </Card.Content>
    </Card>
);
        ...
        <>
            ...
            <TransitionablePortal
                ...
                <Segment
                    ...
                    <Header>Mckee Pure Water </Header>
                    <ReceiptCard data={printReceipt} />
                    {/* <pre>
                    ...
                    <Button
                        ...
                        onClick={() => {
                            console.log('Done');
                            setOpen(false);
                            const { membership, newRecordID } = printReceipt;
                            history.push({
                                pathname: '/buy',
                                state: {
                                    ...membership,
